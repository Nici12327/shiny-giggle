...
This file replaces the previous `data/token.py` to avoid shadowing the
standard library `token` module. Keep this file private and out of source
...
token = 'Put your Token Here'  # Replace with your bot token
